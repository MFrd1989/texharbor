...
Planned vertical slices include project activity and version restoration, Google Drive backup and restore, richer notifications, and further source/PDF synchronization improvements.
